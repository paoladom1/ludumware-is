            ...
            <Layout>
                ...
                <div className="grid grid-cols-3 gap-x-4 gap-y-4 p-2">
                    <div className="col-span-2 row-span-2 h-full bg-white rounded p-9 shadow-lg">
                        <h1 className="text-lg text-center font-bold">Becarios por institución de estudio.</h1>
                        <GraficaBarraH />
                    </div>
                    ...
                    <div className="h-auto bg-white rounded p-9 shadow-lg">
                        <h1 className="text-lg text-center font-bold pb-3">Solicitudes recibidas.</h1>
                        <h2 className="p-8">Lorem ipsum dolor sit amet consectetur adipisicing elit. Dicta rerum animi natus. Saepe exercitationem nisi nulla! Dolor voluptatum, tenetur quasi magnam cupiditate, repellat quo sed fuga, sunt laborum explicabo mollitia?</h2>
                    </div>
